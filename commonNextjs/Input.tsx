...
interface InputProps {
  ...
  id: string,
  type?: string,
  placeholder?: string,   // adds text to the field itself. If you don't use Label prop make sure to use this
  ...
  disabled?: boolean,
  label?: boolean,    // Will add a text label above the input field
  className?: string,
